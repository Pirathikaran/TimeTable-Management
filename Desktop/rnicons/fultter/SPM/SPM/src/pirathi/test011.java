...
//            rooms.add("Select");
    ...
    private void loadSession() {      
            ...
            try {
                String query = "SELECT * FROM Sessions WHERE groupid='"+ gp +"'";
                stmt = conn.prepareStatement(query);
                rs = stmt.executeQuery();
...
//                String query3 = "select time_slot from time_slot where batch=(select batch from workingdays where batch='" + timetableList.get(0) + "')";
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(sesComboBox, javax.swing.GroupLayout.Alignment.TRAILING, 0, 136, Short.MAX_VALUE)
        ...
        jLabel14.setText("Student Group");

        jButton3.setText("Print Time Table");
        ...
        jLabel17.setText("View Student Time Table");
