 ...
 * @author asvin
 */
public class test01_1_1_1 extends javax.swing.JFrame {
    ...
    private void loadStudentGroup() {
        ...
        try {
            ...
            String query = "SELECT distinct * FROM Sessions INNER JOIN SessionLecturers ON Sessions.Id=SessionLecturers.id ";
            ...
            while (rs.next()) {
                studentGroup.add(rs.getString("lecturer"));
            }          
...
//    }
    ...
    private void loadDataToTable() {
        ...
        try {            
            ...
            String query = "select * from timetable where session like '"+grp+"%' ";
            stmt = conn.prepareStatement(query);
            rs = stmt.executeQuery();
...
//                String query3 = "select time_slot from time_slot where batch=(select batch from workingdays where batch='" + timetableList.get(0) + "')";
    ...
    private String getTableData(String room, String batch, String day, String timeslot) {
        ...
        try {
            ...
            String query = "select session from timetable where session like ? and batch=? and day=? and timeSlot=?";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new test01_1_1_1().setVisible(true);
            }
        });
    }
